...
def export(model_dir, iteration, kerasjs_encoder, output_dir=Path(__file__).parent/'frontend'/'public'/'model'/'keras'):
    ...
    subprocess.check_call(['python', kerasjs_encoder, str(output_dir/'model.h5')])
